...
namespace Pe.ElectroPeru.SGI.Infraestructura.Core.QueryContract.Mantenimiento
{
    ...
    /// </remarks>
    public interface IIndicadorEvaluacionLogicRepository : IQueryRepositoryLogic<IndicadorEvaluacionLogic>
    {
        /// <summary>
        /// Permite la búsqueda de los registros de ObjetivoEstrategicoSectorial
        /// </summary>
        List<IndicadorEvaluacionLogic> BuscarIndicadorEvaluacion(
