...
namespace Pe.ElectroPeru.SGI.Infraestructura.Repository.Command.Seguridad
{
    public class AsignacionEntityRepository : ComandRepository<AsignacionEntity>, IAsignacionEntityRepository
    {
    }
}
