...
using Pe.ElectroPeru.SGI.Presentacion.Core.ViewModel.Politicas.Parametro;
using Pe.ElectroPeru.SGI.Transversal.Core.Constante;
using Pe.ElectroPeru.SGI.Presentacion.Core.ViewModel.Politicas.SeccionParametro;
...
namespace Pe.ElectroPeru.SGI.Presentacion.Core.Controllers.Politicas
{
    ...
    public class SeccionParametroController : GenericController
    {
        ...
        public ActionResult FormularioSeccionParametro(int codigoParametro, int? codigoSeccion)
        {
            ...
            model.Parametro = parametroService.BuscarParametro(new ParametroRequest() { CodigoParametro = codigoParametro, CodigoEmpresa = DatosConstantes.Empresa.CodigoElectroPeru }).Result.FirstOrDefault();
