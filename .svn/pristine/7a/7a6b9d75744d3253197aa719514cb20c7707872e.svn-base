...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Base.TrabajadorSuplente');
Pe.ElectroPeru.SGI.Presentacion.Base.TrabajadorSuplente.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        'use strict'
        ...
        base.Control.TfSuplente = new Pe.GMD.UI.Web.Components.TokenField({
            data: Pe.ElectroPeru.SGI.Presentacion.Contractual.BandejaContrato.Actions.BuscarTrabajadorUO,
            ...
            //prePopulate: base.Function.AdaptarListaToken(Pe.ElectroPeru.SGI.Presentacion.Core.ViewModel.Politicas.Trabajador.TrabajadorSuplenteModel.Model.ListaNombreRepresentante)
        });
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Contractual.BandejaContrato.Actions.RegistrarTrabajadorSuplente,
            autoSubmit: false,
    ...
    base.Show = function (codigoTrabajador) {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Contractual.BandejaContrato.Actions.FormularioTrabajadorSuplente,
            onSuccess: function () {
                base.Ini();
            },
        });
