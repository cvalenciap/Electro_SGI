ns('Pe.ElectroPeru.SGI.Presentacion.Seguimiento.Records.FormularioRecordAccion');
Pe.ElectroPeru.SGI.Presentacion.Seguimiento.Records.FormularioRecordAccion.Controller = function (opts) {
    var base = this;
    ...
    base.Show = function (opts) {
        base.Control.DlgFormularioRecordAccion = new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Seguimiento.Records.TitulosVentanas.Accion,
            size: "size-wide",
            close: function () {
        ...
        base.Control.DlgFormularioRecordAccion.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Seguimiento.Records.RegistroRecord.Actions.FormularioRecordAccion,
            onSuccess: function () {
                base.Ini();
            },
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Seguimiento.Records.RegistroRecord.Actions.RegistrarRecordAccion,
            autoSubmit: false,
