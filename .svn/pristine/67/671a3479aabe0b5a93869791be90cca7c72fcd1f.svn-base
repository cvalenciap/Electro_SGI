...
Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Index.Controller = function () {
    var base = this;
    base.Ini = function () {
        'use strict';

        base.Control.Trabajador = Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Models.Index;
        ...
        base.Control.DlgFormularioTrabajador = new Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajador.Controller({
            GrabarSuccess: base.Event.BtnBuscarClick
        });

        base.Control.DlgFormularioTrabajadorUnidadOperativa = new Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajadorUnidadOperativa.Controller({
            //GrabarSuccess: base.Event.BtnBuscarClick
        });

        base.Control.DlgFormularioTrabajadorSuplente = new Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajadorSuplente.Controller({
            //GrabarSuccess: base.Event.BtnBuscarClick
        });
        ...
        base.Control.MdlBusquedaUsuarioAD = new Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Controller({
            DespuesDeAgregar: base.Event.CargarUsuarioAD
        });

        // Modal de carga de archivos.
        base.Control.MdlAgregarArchivoFirma = new Pe.ElectroPeru.SGI.Presentacion.Base.CargarArchivo.Controller({
    ...
    base.Event = {
        ...
        BtnEliminarClick: function () {
            ...
            if (datos.length > 0) {
                base.Control.DlgFormularioEliminar.Confirmation({
                    title: Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.TituloEliminar,
                    message: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.EtiquetaEliminarDescripcion,
                    onAccept: function () {
        ...
        AjaxEliminarSuccess: function (data) {
            base.Control.Mensaje.Information({ message: Pe.ElectroPeru.SGI.Presentacion.Recursos.Validacion.SeEliminoRegistro });
            base.Event.BtnBuscarClick();
        },
        ...
        AjaxCargarFileSucess: function (rpta) {
            ...
            if (rpta.IsSuccess) {
                base.Event.BtnBuscarClick();
                base.Control.Mensaje.Information({ message: Pe.ElectroPeru.SGI.Presentacion.Base.MensajeGenerico.SeGuardoInformacionExito });
            } else {
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.Eliminar,
            autoSubmit: false,
            onSuccess: base.Event.AjaxEliminarSuccess
        }),
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.RegistrarValidar,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGrabarSuccess
        }),
        AjaxVerFile: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.VerFirmaTrabajador,
            autoSubmit: false,
            onSuccess: base.Event.AjaxVerFileSucess
        }),
        AjaxCargarFile: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.CargarFirmaTrabajador,
            hasFile: true,
            autoSubmit: false,
            contentType: false,
            processData: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({ data: 'CodigoIdentificacion', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridCodigoIdentificacion });
            columns.push({ data: 'DescripcionTipoDocumentoIdentidad', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridCodigoTipoDocumento });
            columns.push({ data: 'NumeroDocumentoIdentidad', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridNumeroDocumentoIdentidad });
            columns.push({ data: 'NombreCompleto', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridNombres });
            columns.push({ data: 'Organizacion', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridOrganizacion });
            columns.push({ data: 'Departamento', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridDepartamento });
            columns.push({ data: 'Cargo', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridCargo });
            columns.push({ data: 'TelefonoTrabajo', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridTelefonoTrabajo });
            columns.push({ data: 'Anexo', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridAnexo });
            columns.push({ data: 'TelefonoMovil', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridTelefonoMovil });
            columns.push({ data: 'TelefonoPersonal', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridTelefonoPersonal });
            columns.push({ data: 'CorreoElectronico', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Resource.GridCorreoElectronico });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.Buscar,
                    source: 'Result'
                }
            });
        },
