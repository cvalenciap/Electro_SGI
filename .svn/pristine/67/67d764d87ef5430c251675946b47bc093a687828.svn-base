ns('Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Index');
Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Index.Controller = function () {
    var base = this;

    base.Ini = function () {
        'use strict'
        base.Control.SistemaModel = $.parseJSON(Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Models.Sistema);
        ...
        base.Control.DlgFormulario = new Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Formulario.Controller({
        ...
        btnGridEditarClick: function (row, data) {
            ...
            if (data.Permiso == 5 || data.Permiso == 3 || data.Permiso == 2) {
                if (data.EstadoRegistro != Pe.ElectroPeru.SGI.Transversal.Core.Constante.DatosConstantes.Inactivo) {
                    base.Control.DlgFormulario.Show({
                        data: { CodigoSistema: data.CodigoSistema }
                    });
                }
                else {
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Actions.Eliminar,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                ...
                data: 'Nombre',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Resources.GridNombre,
                width: "25%"
            });
            ...
            columns.push({
                filter: { enabled: true, type: "textbox" },
                data: 'Descripcion',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Resources.GridDescripcion,
                width: "25%"
            });
            ...
            columns.push({
                filter: { enabled: true, type: "textbox" },
                data: 'Ruta',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Resources.GridRuta,
                width: "15%"
            });
            ...
            columns.push({
                filter: { enabled: true, type: "textbox" },
                data: 'Token',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Resources.GridToken,
                width: "15%"
            });

            columns.push({
                filter: { enabled: true, type: "select", data: base.Control.SistemaModel.ListaEstado },
                data: 'EstadoRegistroDescripcion',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Resources.GridEstado,
                width: "30%"
            });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                scrollX: '',
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Sistema.Actions.Buscar,
                    source: 'Result'
                }
            });
        }
