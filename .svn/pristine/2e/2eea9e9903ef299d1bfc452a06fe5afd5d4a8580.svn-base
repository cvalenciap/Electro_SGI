...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Base.BuscarProveedor');
Pe.ElectroPeru.SGI.Presentacion.Base.BuscarProveedor.Controller = function (opts) {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.DlgForm.setTitle(Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorProveedor.Resource.EtiquetaTitulo);
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({ data: 'NumeroDocumento', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorProveedor.Resource.GridRucProveedor });
            columns.push({ data: 'Nombre', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorProveedor.Resource.GridNombreProveedor });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorProveedor.Actions.BuscarProveedorOracle,
                    source: 'Result'
                }
            });
        },
    ...
    base.Show = function (isMultiSelectParam) {
        ...
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Base.Actions.FormularioBuscarProveedor,
            onSuccess: function () {
                base.Ini();
            }
        });
