<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportViewControl.ascx.cs" Inherits="Pe.ElectroPeru.SGI.Presentacion.Areas.Base.Views.GestionLesiones.ReportViewControl" %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<%@ Import Namespace="Pe.ElectroPeru.SGI.Presentacion.Core.ViewModel.Base" %>
