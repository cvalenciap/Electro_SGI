...
Pe.ElectroPeru.SGI.Presentacion.Mantenimiento.Area.Index.Controller = function () {
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                filter: { enabled: true, type: "select", data: base.Control.AreaModel.ListaProyecto },
                data: 'NombreProyecto',
                title: Pe.ElectroPeru.SGI.Presentacion.Mantenimiento.Area.Resources.GridProyecto,
                width: "25%"
            });

            columns.push({
                filter: { enabled: true, type: "select", data: base.Control.AreaModel.ListaCodigoDepartamento },
                data: 'NombreDepartamento',
                title: Pe.ElectroPeru.SGI.Presentacion.Mantenimiento.Area.Resources.GridDepartamento,
                width: "25%"
            });
            ...
            columns.push({
                ...
                title: Pe.ElectroPeru.SGI.Presentacion.Mantenimiento.Area.Resources.GridNombreColaboradorResponsable,
                width: "25%"
            });
