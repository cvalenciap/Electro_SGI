...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.FormularioSeccionParametro');
Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.FormularioSeccionParametro.Controller = function () {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.Validador = new Pe.GMD.UI.Web.Components.Validator({
            ...
            messages: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Resources.Validacion,
    ...
    base.Show = function (opts) {
        ...
        base.Control.DlgForm.getAjaxContent(
            {
                action: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Actions.FormularioSeccionParametro,
                onSuccess: function () {
                    base.Ini();
                },
                data: {
    ...
    base.Control = {
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Resources.FormularioSeccionParametrosGenerales
        }),
    ...
    base.Event = {
        ...
        AjaxGrabarSuccess: function (data) {
            switch (data.Result) {
                case "2":
                    base.Control.Mensaje.Warning({ message: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Resources.Validacion.ValidarNombreSeccionRepetido });
    ...
    base.Ajax = {
        ...
        {
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Actions.BuscarSeccionParametro,
            autoSubmit: false,
        ...
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.SeccionParametro.Actions.GuardarSeccionParametro,
            autoSubmit: false,
    ...
    base.Function = {
        LimpiarSlcSeccionRelacionadaFormulario: function () {
            ...
            base.Control.SlcSeccionRelacionadaFormulario().append(new Option(Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaSeleccionar, ""));
        },
        LimpiarSlcSeccionRelacionadaVisibleFormulario: function () {
            base.Control.SlcSeccionRelacionadaVisibleFormulario().empty();
            base.Control.SlcSeccionRelacionadaVisibleFormulario().append(new Option(Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaSeleccionar, ""));
        },
