...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.ReporteRiesgos.BandejaReporteRiesgos.Index');
Pe.ElectroPeru.SGI.Presentacion.ReporteRiesgos.BandejaReporteRiesgos.Index.Controller = function () {
    var base = this;
    ...
    base.Function = {
        CrearGridBandejaReporteRiesgos: function () {
            ...
            columns.push({
                ...
                width: "12%",
                actionButtons: [
                    { type: Pe.GMD.UI.Web.Components.GridAction.Revisar, event: { on: 'click', callBack: base.Event.BtnGridRevisarReporteRiesgosClick } },
                    { type: Pe.GMD.UI.Web.Components.GridAction.Edit, validateRender: base.Event.BtnValidarEstadoReporteRiesgos, event: { on: 'click', callBack: base.Event.BtnGridEditReporteRiesgosClick } },
                    { type: Pe.GMD.UI.Web.Components.GridAction.Pdf, event: { on: 'click', callBack: base.Event.BtnGridDescargarReporteReporteRiesgosClick }, toolTip: 'Descargar Reporte de Riesgos' }                    
                ]
            });
