...
/// </summary>
/// <remarks>
/// Creacion: 	GMD 24102017
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.BandejaAP_A.Index');
Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.BandejaAP_A.Index.Controller = function () {
    var base = this;
    ...
    base.Control = {
        ...
        SlcValorIndicador: function () { return $('#slcValorIndicador'); },
    ...
    base.Event = {
        BtnBuscarClick: function () {
            ...
            var filtro = {
                ...
                CodigoValorIndicador: base.Control.SlcValorIndicador().val(),
            };
        ...
        BtnGridRevisarActuaPositivoClick: function (row, data) {
            ...
            Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.Index.Actions.IngresoAP_A, filtro);
        },
        ...
        BtnLimpiarClick: function () {
            ...
            base.Control.SlcValorIndicador().val('')
        ...
        BtnGridRevisarValidate: function (data, type, full) {
            if (base.Control.BandejaAP_AModel.RecordAccion.Lectura || base.Control.BandejaAP_AModel.RecordAccion.Escritura || base.Control.BandejaAP_AModel.RecordAccion.ControlTotal) {
                return true;
            }
        ...
        btnDescargarExcelClick: function () {
            if (base.Control.GrdResultado.core.rows().data().length >= 1) {
                ...
                Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.Index.Actions.DescargarReporteBandejaAP_A, filtro);
            }
            else {
