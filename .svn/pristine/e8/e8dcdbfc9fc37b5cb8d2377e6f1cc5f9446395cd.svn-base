...
{
    public class ObjetivoEstrategicoSectorialDetalleLogicRepository : QueryRepository<ObjetivoEstrategicoSectorialDetalleLogic>, IObjetivoEstrategicoSectorialDetalleLogicRepository
    {
        /// <summary>
        /// Permite la búsqueda de Mantenimiento
        /// </summary>      
        public List<ObjetivoEstrategicoSectorialDetalleLogic> BuscarObjetivoEstrategicoSectorialDetalle(
            ...
            long tamanioPagina)
        {
            ...
            {                
                new SqlParameter("CODIGO_OBJETIVO_ESTRATEGICO_SECTORIAL_DETALLE", SqlDbType.UniqueIdentifier) { Value = (object)codigoObjetivoEstrategicoSectorialDetalle ?? DBNull.Value },
                new SqlParameter("CODIGO_OBJETIVO_ESPECIFICO_EMPRESA", SqlDbType.UniqueIdentifier)         { Value = (object)codigoObjetivoEstrategicoSectorial ?? DBNull.Value },                
            ...
            var resultado = this.dataBaseProvider.ExecuteStoreProcedure<ObjetivoEstrategicoSectorialDetalleLogic>("MNT.USP_OBJETIVO_ESTRATEGICO_SECTORIAL_DETALLE_SEL", parametros).ToList();
            return resultado;
        }
    }
}
