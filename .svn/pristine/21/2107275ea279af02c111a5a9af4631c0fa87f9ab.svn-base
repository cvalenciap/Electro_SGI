...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajador');
Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajador.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        'use strict'
    ...
    base.Control = {
        ...
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.EtiquetaTituloPrincipal
        }),
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.Registrar,
            autoSubmit: false,
    ...
    base.Show = function (codigoTrabajador) {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.FormularioTrabajador,
            onSuccess: function () {
                base.Ini();
            },
