...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Base.BuscarTrabajador');
Pe.ElectroPeru.SGI.Presentacion.Base.BuscarTrabajador.Controller = function (opts) {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.DlgForm.setTitle(Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Resource.EtiquetaTitulo);
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({ data: 'CodigoIdentificacion', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Resource.GridNombreUsuario });
            columns.push({ data: 'NumeroDocumentoIdentidad', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Resource.GridNumeroDocumento });
            columns.push({ data: 'NombreCompleto', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Resource.GridNombreTrabajador });
            columns.push({ data: 'CorreoElectronico', title: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Resource.GridCorreoElectronico, width: '200px' });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Base.BuscadorTrabajador.Actions.Buscar,
                    source: 'Result'
                }
            });
        },
    ...
    base.Show = function (isMultiSelectParam) {
        ...
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Base.Actions.FormularioBuscarTrabajador,
            onSuccess: function () {
                base.Ini();
            }
        });
