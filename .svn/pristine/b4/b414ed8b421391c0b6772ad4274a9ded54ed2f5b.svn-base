...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD');

Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Controller = function (parametros) {
    var base = this;
    base.MostrarBusquedaAD = function () {
        'use strict'
        base.Control.DialogFormularioBusquedaAD.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Actions.VistaBusquedaUsuarioAD,
            onSuccess: function () {
    ...
    base.Control = {
        DialogFormularioBusquedaAD: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.EtiquetaTitulo
        }),
    ...
    base.Event = {
        ...
        BtnBuscarUsuarioAD: function () {
            ...
            if (usuario === "") {
                base.Control.Mensaje.Warning({
                    title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.EtiquetaAgregarUsuario,
                    message: Pe.ElectroPeru.SGI.Presentacion.Recursos.Validacion.DebeIngresarDato
                });
            } else if (dominio === "") {
                base.Control.Mensaje.Warning({
                    title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.EtiquetaAgregarUsuario,
        ...
        BtnAgregarUserAD: function () {
            ...
            if (selectedData.length == 0 || selectedData.length > 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.EtiquetaAgregarUsuario,
                    message: Pe.ElectroPeru.SGI.Presentacion.Recursos.Validacion.DebeSeleccionarUnRegistro
                });
            } else {
    ...
    base.Ajax = {
        AjaxBuscar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Actions.BuscarUsuarioAD,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function (data) {
            ...
            columns.push({ data: 'Alias', title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.GridUsuario });
            columns.push({ data: 'NombreCompleto', title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.GridNombres });
            columns.push({ data: 'CorreoElectronico', title: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Resource.GridEmail });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                //scrollY: '150px',
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Base.UsuarioAD.Actions.BuscarUsuarioAD,
                    source: 'Result'
                }
            });
        }
