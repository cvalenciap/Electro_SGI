ns('Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.BandejaAP_A.FormularioSeleccionarSupervisor');
Pe.ElectroPeru.SGI.Presentacion.ActuaPositivo.BandejaAP_A.FormularioSeleccionarSupervisor.Controller = function (opts) {
    var base = this;
