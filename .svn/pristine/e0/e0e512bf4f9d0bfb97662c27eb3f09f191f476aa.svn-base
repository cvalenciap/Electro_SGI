...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IIndicadorEvaluacionService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<IndicadorEvaluacionResponse>> BuscarIndicadorEvaluacion(IndicadorEvaluacionRequest filtro);
        ...
        ProcessResult<IndicadorEvaluacionResponse> RegistrarIndicadorEvaluacion(IndicadorEvaluacionRequest data);
        ...
        ProcessResult<object> EliminarIndicadorEvaluacion(IndicadorEvaluacionRequest filtro);
