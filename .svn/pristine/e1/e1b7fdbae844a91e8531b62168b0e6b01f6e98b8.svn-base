...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<ObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalResponse>> BuscarObjetivoEstrategicoEmpresaAccionEstrategicaInstitucional(ObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalRequest filtro);
        ...
        ProcessResult<ObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalResponse> RegistrarObjetivoEstrategicoEmpresaAccionEstrategicaInstitucional(ObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalRequest data);
        ...
        ProcessResult<object> EliminarObjetivoEstrategicoEmpresaAccionEstrategicaInstitucional(ObjetivoEstrategicoEmpresaAccionEstrategicaInstitucionalRequest filtro);
