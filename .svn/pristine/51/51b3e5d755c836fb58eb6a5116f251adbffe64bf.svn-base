...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Seguimiento.DocCerradoGerencia.Index');
Pe.ElectroPeru.SGI.Presentacion.Seguimiento.DocCerradoGerencia.Index.Controller = function () {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.DocCerradoGerenciaModel = Pe.ElectroPeru.SGI.Presentacion.Seguimiento.DocCerradoGerencia.Models.DocCerradoGerenciaModel;
        ...
        AjaxObtenerDocumentoSuccess: function (resultado) {
            ...
            if (resultado.Result.ExisteDocumento == true) {
                ...
                if (resultado.Result.EstadoCerradoGerencia != true && resultado.Result.EstadoAnuladoGerencia != true && resultado.Result.EstadoAnulado != true) {
                    ...
                    Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.ElectroPeru.SGI.Presentacion.Seguimiento.DocCerradoGerencia.Index.Actions.FormularioDocCerradoGerencia, filtro);
                }
    ...
    base.Ajax = {
        AjaxObtenerDocumento: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Seguimiento.DocCerradoGerencia.Index.Actions.ObtenerDocumento,
            autoSubmit: false,
