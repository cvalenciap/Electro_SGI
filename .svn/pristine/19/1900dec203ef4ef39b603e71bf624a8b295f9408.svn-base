...
Pe.GMD.UI.Web.Components.GridAction = {
    ...
    Temas: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.GridTemas;
    ...
    Edit: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaEditar;
    ...
    Delete: {
        ...
        //}
        Source: function (id, tooltip, index) {
            tooltip = tooltip ? tooltip : Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaEliminar;
    ...
    DescargarAdjunto: {
        ...
        Icon: 'fa-download',
        //Source: function (id) {
        //    return Pe.GMD.UI.Web.Components.Util.RenderIcono('descargar', 'fa-download fa-download-' + id, Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.GridDescargar);
        //}
        Source: function (id, tooltip, index) {
