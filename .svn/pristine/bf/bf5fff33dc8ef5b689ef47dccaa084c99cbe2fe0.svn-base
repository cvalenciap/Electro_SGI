...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IFormulaService : IGenericService
    {       
        ...
        ProcessResult<FormulaResponse> RegistrarFormula(FormulaRequest data);
        ...
        ProcessResult<object> EliminarFormula(FormulaRequest filtro);
        ...
        ProcessResult<object> ReactivarFormula(FormulaRequest filtro);
    }
}
