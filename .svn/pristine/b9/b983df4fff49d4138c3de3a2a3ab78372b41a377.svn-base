...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativa.FormularioUnidadOperativa');
Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativa.FormularioUnidadOperativa.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        'use strict'
        ...
        base.Control.DlgFormularioBusquedaTrabajador = new Pe.ElectroPeru.SGI.Presentacion.Base.BuscarTrabajador.Controller({
    ...
    base.Control = {
        ...
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativaResource.EtiquetaTituloFormulario
        }),
    ...
    base.Event = {
        ...
        AjaxBuscarUnidadSuperiorSuccess: function (resultado) {
            ...
            base.Control.SlcUnidadSuperior().append(new Option(Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaSeleccionar, ""));
    ...
    base.Ajax = {
        ...
        {
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativa.Actions.BuscarTipoUnidadOperativa,
            autoSubmit: false,
            onSuccess: base.Event.AjaxBuscarTipoUnidadSuccess
        }),
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativa.Actions.Registrar,
            autoSubmit: false,
    ...
    base.Show = function (data) {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.UnidadOperativa.Actions.FormularioUnidadOperativa,
            onSuccess: function () {
                base.Ini();
            },
            data: {
