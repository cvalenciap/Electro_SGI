...
{
    /// <summary>
    /// Controladora de Bandeja de AccionEstrategicaSectoriales
    /// </summary>
    /// <remarks>
    ...
    public class BandejaAccionEstrategicaSectorialController : BaseController
    {
        #region Propiedades
        /// <summary>
        ...
        /// <returns></returns>
        public ActionResult Index(BandejaAccionEstrategicaSectorialRequest filtro)
        {
        ...
        public JsonResult BuscarAccionEstrategicaSectorial(BandejaAccionEstrategicaSectorialRequest filtro)
        {
            ...
            var response = accionEstrategicaSectorialService.BuscarAccionEstrategicaSectorial(filtro);
