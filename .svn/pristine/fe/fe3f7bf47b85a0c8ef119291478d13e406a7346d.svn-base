...
{
    public class IndicadorValorLogicRepository : QueryRepository<IndicadorValorLogic>, IIndicadorValorLogicRepository
    {
        /// <summary>
        /// Permite la búsqueda de Mantenimiento
        /// </summary>      
        public List<IndicadorValorLogic> BuscarIndicadorValor(
            Guid? codigoIndicadorValor,
            ...
            long tamanioPagina)
        {
            ...
            {                
                new SqlParameter("CODIGO_INDICADOR_VALOR", SqlDbType.UniqueIdentifier) { Value = (object)codigoIndicadorValor ?? DBNull.Value },
            ...
            var resultado = this.dataBaseProvider.ExecuteStoreProcedure<IndicadorValorLogic>("MNT.USP_INDICADOR_VALOR_SEL", parametros).ToList();
            return resultado;
        }
    }
}
