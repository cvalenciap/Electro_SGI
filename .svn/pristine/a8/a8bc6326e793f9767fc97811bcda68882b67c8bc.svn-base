...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.FormularioParametro');
Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.FormularioParametro.Controller = function () {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.Validador = new Pe.GMD.UI.Web.Components.Validator({
            ...
            messages: Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.Resources.Validacion,
    ...
    base.Show = function (opts) {
        ...
        base.Control.DlgForm.getAjaxContent(
            {
                action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.Actions.FormularioParametro,
                onSuccess: function () {
                    base.Ini();
                },
                data: opts.data
    ...
    base.Control = {
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.Resources.FormularioParametrosGenerales
        }),
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Parametro.Actions.GuardarParametro,
            autoSubmit: false,
