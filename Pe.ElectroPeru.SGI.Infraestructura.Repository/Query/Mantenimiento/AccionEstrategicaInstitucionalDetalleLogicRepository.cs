...
{
    public class AccionEstrategicaInstitucionalDetalleLogicRepository : QueryRepository<AccionEstrategicaInstitucionalDetalleLogic>, IAccionEstrategicaInstitucionalDetalleLogicRepository
    {
        /// <summary>
        /// Permite la búsqueda de Mantenimiento
        /// </summary>      
        public List<AccionEstrategicaInstitucionalDetalleLogic> BuscarAccionEstrategicaInstitucionalDetalle(
            ...
            long tamanioPagina)
        {
            ...
            {                
                new SqlParameter("CODIGO_ACCION_ESTRATEGICA_INSTITUCIONAL_DETALLE", SqlDbType.UniqueIdentifier) { Value = (object)codigoAccionEstrategicaInstitucionalDetalle ?? DBNull.Value },
            ...
            var resultado = this.dataBaseProvider.ExecuteStoreProcedure<AccionEstrategicaInstitucionalDetalleLogic>("MNT.USP_ACCION_ESTRATEGICA_INSTITUCIONAL_DETALLE_SEL", parametros).ToList();
            return resultado;
        }
    }
}
