...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.FormularioPlantillaNotificacion');
Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.FormularioPlantillaNotificacion.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
    ...
    base.Event = {
        ...
        BtnGrabarClick: function () {
            base.Control.Mensaje.Confirmation({
                title: Pe.ElectroPeru.SGI.Presentacion.Recursos.Validacion.EtiquetaTituloConfirmar,
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Actions.RegistraPlantillaNotificacion,
            autoSubmit: false,
    ...
    base.Show = function (codigoPlantillaNotificacion) {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Actions.FormularioPlantillaNotificacion,
            onSuccess: function () {
                base.Ini();
            },
