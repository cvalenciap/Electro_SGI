ns('Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Index');
Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Index.Controller = function () {
    var base = this;

    base.Ini = function () {
        'use strict'
        base.Control.PerfilModel = $.parseJSON(Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Models.Perfil);
        ...
        base.Control.DlgFormulario = new Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Formulario.Controller({
    ...
    base.Control = {
        ...
        hdCodigoSistema: function () { return $('#hdCodigoSistema'); },
        ...
        btnGridEditarClick: function (row, data) {
            ...
            if (data.Permiso == 5 || data.Permiso == 3 || data.Permiso == 2) {
                if (data.EstadoRegistro != Pe.ElectroPeru.SGI.Transversal.Core.Constante.DatosConstantes.Inactivo) {
                    base.Control.DlgFormulario.Show({
                        data: { CodigoPerfil: data.CodigoPerfil, CodigoSistema: data.CodigoSistema }
                    });
                }
                else {
                    ...
                    base.Control.Mensaje.Delete({
                        ...
                        onAccept: function () {
                            base.Ajax.AjaxEliminar.data = {
                                CodigoPerfil: data.CodigoPerfil,
                            };
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Actions.Eliminar,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                ...
                data: 'Sistema',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Resources.GridSistema,
                width: "25%"
            });
            ...
            columns.push({
                filter: { enabled: true, type: "textbox" },
                data: 'Nombre',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Resources.GridNombre,
                width: "25%"
            });
            ...
            columns.push({
                filter: { enabled: true, type: "textbox" },
                data: 'Descripcion',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Resources.GridDescripcion,
                width: "25%"
            });

            columns.push({
                filter: { enabled: true, type: "select", data: base.Control.PerfilModel.ListaEstado },
                data: 'EstadoRegistroDescripcion',
                title: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Resources.GridEstado,
                width: "30%"
            });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                scrollX: '',
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Seguridad.Perfil.Actions.Buscar,
                    source: 'Result'
                }
            });
        }
