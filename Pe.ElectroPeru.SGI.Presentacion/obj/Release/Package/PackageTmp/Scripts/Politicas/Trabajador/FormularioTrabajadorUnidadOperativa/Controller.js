...
/// </remarks>
ns('Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajadorUnidadOperativa');
Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.FormularioTrabajadorUnidadOperativa.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        'use strict'
        ...
        base.Control.DlgForm.setTitle(Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.EtiquetaTituloPrincipalTrabajadorUnidadOperativa + " " + base.Control.HdnNombreTrabajador().val());
    ...
    base.Control = {
        ...
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.EtiquetaTituloPrincipalTrabajadorUnidadOperativa
        }),
    ...
    base.Event = {
        SlcFrmUnidadOperativaMatrizChange: function () {
            ...
            base.Control.SlcFrmUnidadOperativa().append(new Option(Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaSeleccionar, ""));
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.RegistrarTrabajadorUnidadOperativa,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGrabarSuccess
        }),
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.EliminarTrabajadorUnidadOperativa,
            autoSubmit: false,
        ...
        AjaxBuscarUnidadOperativaProyectoPorEmpresaMatriz: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.BuscarUnidadOperativaProyectoPorEmpresaMatriz,
            autoSubmit: false,
    ...
    base.Show = function (codigoTrabajador) {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.FormularioTrabajadorUnidadOperativa,
            onSuccess: function () {
                base.Ini();
            },
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({ data: 'NombreUnidadOperativa', title: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.EtiquetaProyecto });
            columns.push({
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Politicas.Trabajador.Actions.BuscarTrabajadorUnidadOperativa,
                    source: 'Result'
                },
