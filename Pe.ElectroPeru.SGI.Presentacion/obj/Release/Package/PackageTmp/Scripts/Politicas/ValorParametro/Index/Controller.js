...
Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Index.Controller = function () {
    var base = this;
    base.Ini = function () {
        ...
        base.Control.FrmRegister = new Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.FormularioParametro.Controller();
    };
    base.Control = {
        ListaSeccion: null,
    ...
    base.Event = {
        ...
        BtnEliminarClick: function () {
            ...
            if (selectedData.length < 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Resources.EtiquetaTituloAdvertencia,
                    message: Pe.ElectroPeru.SGI.Presentacion.Recursos.Validacion.SeleccionarRegistroEliminar
                });
            }
            else {
                base.Control.Mensaje.Confirmation({
                    title: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Resources.TituloEliminar,
                    message: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Resources.MsgEliminar,
                    onAccept: function () {
        ...
        BtnGridEditClick: function (row, data) {
            base.Control.FrmRegister.Show({
                ...
                data: { codigoParametro: data.CodigoParametro, codigoValor: data.CodigoValor },
                title: ((base.Control.ParametroActual != null) ? base.Control.ParametroActual.Nombre : '')
            });
        },
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Actions.EliminarParametro,
            autoSubmit: false,
            onSuccess: base.Event.AjaxEliminarSuccess
        }),
        AjaxSearch: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Actions.BuscarParametro,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function (data) {
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Politicas.ValorParametro.Actions.Buscar,
                    source: 'Result'
                }
            });
        },
