...
Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Index.Controller = function () {
    var base = this;


    base.Ini = function () {
        base.Control.DlgFormularioPlantillaNotificacion = new Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.FormularioPlantillaNotificacion.Controller({
            GrabarSuccess: base.Event.BtnBuscarClick
        });

        base.Control.PlantillaNotificacion = Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Models.Index;
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'Asunto',
                title: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Resources.GridAsunto,
                width: "25%",
                "class": "left"
            });
            columns.push({
                data: 'ContenidoReCortado',
                title: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Resources.GridContenido,
                width: "35%",
                "class": "left"
            });
            columns.push({
                data: 'IndicadorActiva',
                title: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Resources.GridPlantillaActiva,
            ...
            columns.push({
                data: 'Destinatario',
                title: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Resources.GridDestinatario,
                width: "15%",
                "class": "left"
            });
            columns.push({
                data: 'DestinatarioCopia',
                title: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Resources.GridDestinatarioCopia,
                width: "15%",
                "class": "left"
            });
            columns.push({
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.ElectroPeru.SGI.Presentacion.Politicas.PlantillaNotificacion.Actions.BuscarBandejaPlantillaNotificacion,
                    source: 'Result'
                }
            });
        }
