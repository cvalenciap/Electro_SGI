ns('Pe.ElectroPeru.SGI.Presentacion.Base.CargarArchivo');

Pe.ElectroPeru.SGI.Presentacion.Base.CargarArchivo.Controller = function (opts) {
    var base = this;
    base.Ini = function () {        
    ...
    base.MostrarModalCargarArchivo = function () {
        base.Control.DialogFormularioCarga.getAjaxContent({
            action: Pe.ElectroPeru.SGI.Presentacion.Base.CargarArchivo.Actions.VistaCargaArchivo,
            data: {},
            onSuccess: function () {
                base.Ini();
            }
    ...
    base.Event = {
        ...
        BtnAceptarFileClick: function () {
            if (base.Control.TxtUploadFile().val() == "" || base.Control.TxtUploadFile().val() == null) {
                base.Control.Mensaje.Warning({ title: base.Control.LblTitleModal, message: Pe.ElectroPeru.SGI.Presentacion.Base.MensajeGenerico.MsjValidaEligeArchivo });
                return;
            }
        ...
        FileArchivoEvidenciaChange: function (data) {            
            if (base.Control.ValidateExt) {
                if (base.Control.ExtensionFile != null) {
                    ...
                    if (!esValido) {
                        base.Control.Mensaje.Warning({ title: base.Control.LblTitleModal, message: Pe.ElectroPeru.SGI.Presentacion.Base.MensajeGenerico.MsjValidaExtensionArchivo + " (" + base.Control.ExtensionFileMensaje + ")" });
