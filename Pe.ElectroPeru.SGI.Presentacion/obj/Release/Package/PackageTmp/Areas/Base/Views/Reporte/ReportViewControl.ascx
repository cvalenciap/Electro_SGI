<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportViewControl.ascx.cs" Inherits="Pe.ElectroPeru.SGI.Presentacion.Areas.Base.Views.Reporte.ReportViewControl" %>
