...
Pe.GMD.UI.Web.Components.Message.prototype = {
    ...
    Reactivate: function (opts) {
        BootstrapDialog.show({
            title: '<h4 class="modal-title"><i></i>' + 'Se reactivó el registro con éxito' + '</h4>',
            size: BootstrapDialog.SIZE_LARGE,
            message: '<div class="cont-critico"><span class="img-item-eliminar"></span><span class="texto-item">' + '¿Desea reactivar el registro?' + '  </span></div></div>',
            buttons: [{
                label: Pe.ElectroPeru.SGI.Presentacion.Base.GenericoResource.EtiquetaNo,
                cssClass: 'btn-cancelar-form',
                action: function (dialogItself) {
