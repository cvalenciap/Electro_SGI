...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Base
{
    public interface ISharePointService : IGenericService
    {
        ...
        /// <summary>
        /// Método para retornar directorio del repositorio SharePoint.
        /// </summary>
        ProcessResult<string> RetornaDirectorioFile();
