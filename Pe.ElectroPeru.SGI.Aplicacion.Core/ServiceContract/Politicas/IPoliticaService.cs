...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Politicas
{
    ...
    public interface IPoliticaService : IGenericService
    {
        ...
        ProcessResult<List<dynamic>> ListarRepositorioSharePointDinamicoSGSA(ParametroValorRequest filtro = null);
        ...
        ProcessResult<List<CodigoValorResponse>> ListarRepositorioSharePointSGSA(ParametroValorRequest filtro = null, string seccion = "2");
        ...
        ProcessResult<List<CodigoValorResponse>> ListaCuentaNotificacionSGSA(ParametroValorRequest filtro = null, string seccion = "2");
        ...
        ProcessResult<List<dynamic>> ListaCuentaNotificacionSGSADinamico(ParametroValorRequest filtro = null);
        ...
        /// <summary>
        /// ListarRecords: método para listar records
        /// </summary>
        /// <param name="filtro"> filtro de Parámetro Valor  </param>
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Records</returns>
        ProcessResult<List<dynamic>> ListarTipoRecordsDinamico(ParametroValorRequest filtro = null);
        ...
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Records</returns>
        ProcessResult<List<CodigoValorResponse>> ListarTipoRecords(ParametroValorRequest filtro = null, string seccion = "2");

        /// <summary>
        /// ListarProjectDinamico: método dinámico para listar los Project
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Project</returns>
        ProcessResult<List<dynamic>> ListarProjectDinamico(ParametroValorRequest filtro = null);

        /// <summary>
        /// ListarProject: método para listar Project
        /// </summary>
        /// <param name="filtro"> filtro de Parámetro Valor  </param>
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Project</returns>
        ProcessResult<List<CodigoValorResponse>> ListarProject(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Company en Records
        ...
        ProcessResult<List<dynamic>> ListarCompanyDinamico(ParametroValorRequest filtro = null);
        ...
        ProcessResult<List<CodigoValorResponse>> ListarCompany(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Clasificaciones en Records
        ...
        ProcessResult<List<dynamic>> ListarClasificationDinamico(ParametroValorRequest filtro = null);
        ...
        ProcessResult<List<CodigoValorResponse>> ListarClasification(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Risk

        /// <summary>
        /// ListarRiskDinamico: método dinámico para listar Risk
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Risk</returns>
        ProcessResult<List<dynamic>> ListarRiskDinamico(ParametroValorRequest filtro = null);
        ...
        ProcessResult<List<CodigoValorResponse>> ListarRisk(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Operating

        /// <summary>
        /// ListarOperatingDinamico: método dinámico para listar Operating
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Operating</returns>
        ProcessResult<List<dynamic>> ListarOperatingDinamico(ParametroValorRequest filtro = null);

        /// <summary>
        /// ListarOperating: método para listar Operating
        /// </summary>
        /// <param name="filtro"> filtro de Parámetro Valor  </param>
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Operating</returns>
        ProcessResult<List<CodigoValorResponse>> ListarOperating(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Idiomas

        /// <summary>
        /// ListarIdiomasDinamico: método dinámico para listar Idiomas
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Idiomas</returns>
        ProcessResult<List<dynamic>> ListarIdiomasDinamico(ParametroValorRequest filtro = null);
        ...
        ProcessResult<List<CodigoValorResponse>> ListarIdiomas(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Idiomas por defecto
        ...
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Idiomas</returns>
        ProcessResult<List<dynamic>> ListarConfiguracionIdiomaPorDefectoDinamico(ParametroValorRequest filtro = null);
        ...
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Idiomas</returns>
        ProcessResult<List<CodigoValorResponse>> ListarConfiguracionIdiomaPorDefecto(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Prioridades

        /// <summary>
        /// ListarPrioridadDinamico: método dinámico para listar Prioridades
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Dinamica Prioridades</returns>
        ProcessResult<List<dynamic>> ListarPrioridadDinamico(ParametroValorRequest filtro = null);
        ...
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Idiomas</returns>
        ProcessResult<List<CodigoValorResponse>> ListarPrioridad(ParametroValorRequest filtro = null, string seccion = "2");

        //Programacion para Listar Estados

        /// <summary>
        /// ListarEstadoDinamico: método dinámico para listar Estados
        /// </summary>
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Estados</returns>
        ProcessResult<List<dynamic>> ListarEstadoDinamico(ParametroValorRequest filtro = null);

        /// <summary>
        /// ListarEstados: método para listar Estados
        /// </summary>
        /// <param name="filtro"> filtro de Parámetro Valor  </param>
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Estados</returns>
        ProcessResult<List<CodigoValorResponse>> ListarEstado(ParametroValorRequest filtro = null, string seccion = "2");
        ...
        /// <param name="filtro">filtro de Parámetro Valor</param>
        /// <returns>Lista Estados</returns>
        ProcessResult<List<dynamic>> ListaRedireccionarDinamico(ParametroValorRequest filtro = null);
        ...
        /// <param name="seccion"> por defecto la sección 2, se puede cambiar de valor caso sea necesario. </param>
        /// <returns>Lista de Estados</returns>
        ProcessResult<List<CodigoValorResponse>> ListaRedireccionar(ParametroValorRequest filtro = null, string seccion = "2");
    }
}
