...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IIndicadorValorService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<IndicadorValorResponse>> BuscarIndicadorValor(IndicadorValorRequest filtro);
        ...
        ProcessResult<IndicadorValorResponse> RegistrarIndicadorValor(IndicadorValorRequest data);
        ...
        ProcessResult<object> EliminarIndicadorValor(IndicadorValorRequest filtro);
