...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IFormulaDetalleService : IGenericService
    {
        /// <summary>
        /// Registrar área
        /// </summary>
        ...
        ProcessResult<FormulaDetalleResponse> RegistrarFormulaDetalle(FormulaDetalleRequest data);
        ...
        ProcessResult<object> EliminarFormulaDetalle(FormulaDetalleRequest filtro);
    }
}
