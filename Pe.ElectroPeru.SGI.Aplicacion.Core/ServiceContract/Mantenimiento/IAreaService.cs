...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IAreaService : IGenericService
    {
        /// <summary>
        ...
        //ProcessResult<List<AreaResponse>> BuscarArea(AreaRequest filtro);
        ...
        /// <param name="filtro">Filtro de búsqueda</param>
        /// <returns>Lista de Áreas</returns>
        ProcessResult<List<AreaResponse>> BuscarAreaGrilla(AreaRequest filtro);
        ...
        ProcessResult<object> RegistrarArea(AreaRequest data);
        ...
        ProcessResult<object> EliminarArea(AreaRequest filtro);
        ...
        //ProcessResult<AreaResponse> ObtenerAreaPorId(int codigoArea);
