...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IAccionEstrategicaInstitucionalDetalleService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<AccionEstrategicaInstitucionalDetalleResponse>> BuscarAccionEstrategicaInstitucionalDetalle(AccionEstrategicaInstitucionalDetalleRequest filtro);
        ...
        ProcessResult<AccionEstrategicaInstitucionalDetalleResponse> RegistrarAccionEstrategicaInstitucionalDetalle(AccionEstrategicaInstitucionalDetalleRequest data);
        ...
        ProcessResult<object> EliminarAccionEstrategicaInstitucionalDetalle(AccionEstrategicaInstitucionalDetalleRequest filtro);
