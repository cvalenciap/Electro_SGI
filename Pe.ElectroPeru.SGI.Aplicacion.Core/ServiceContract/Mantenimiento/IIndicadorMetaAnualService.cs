...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IIndicadorMetaAnualService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<IndicadorMetaAnualResponse>> BuscarIndicadorMetaAnual(IndicadorMetaAnualRequest filtro);
        ...
        ProcessResult<IndicadorMetaAnualResponse> RegistrarIndicadorMetaAnual(IndicadorMetaAnualRequest data);
        ...
        ProcessResult<object> EliminarIndicadorMetaAnual(IndicadorMetaAnualRequest filtro);
