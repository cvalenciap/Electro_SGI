...
namespace Pe.ElectroPeru.SGI.Aplicacion.Core.ServiceContract.Mantenimiento
{
    ...
    /// Modificación:                <br />
    /// </remarks>
    public interface IVariableValorService : IGenericService
    {
        /// <summary>
        ...
        ProcessResult<List<VariableValorResponse>> BuscarVariableValor(VariableValorRequest filtro);
        ...
        ProcessResult<VariableValorResponse> RegistrarVariableValor(VariableValorRequest data);
        ...
        ProcessResult<object> EliminarVariableValor(VariableValorRequest filtro);
