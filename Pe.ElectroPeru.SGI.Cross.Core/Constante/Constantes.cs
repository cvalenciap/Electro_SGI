    ...
    public static class Constantes
    {
        public static class Permisos
        {
            public static class Codigo
            {
                ...
                public const int Nuevo = 4;
                public const int Editar = 5;
                public const int Eliminar = 6;
                public const int Buscar = 7;
            }
        ...
        public static class Controles
        {
            ...
            public static class Alerta
            {
                ...
                public static class Icon
                {
                    ...
                    public const string Success = "glyphicon glyphicon-warning-sign";
                    public const string Info = "glyphicon glyphicon-warning-sign";
                }
        ...
        public static class Sesion
        {
            ...
            public static class Permisos
            {
                ...
                public const string Lista_SupOpciones = "3e1e0330-f2b3-413c-a1e3-d247e4627dbd";
            }
        ...
        {
            public const long TipoPrograma = 1;
            public const long TipoBarra = 2;
            public const long TipoComponenteBarra = 3;
            public const long TipoComponenteEquipo = 4;
            public const long TipoEmpresa = 5;
            public const long TipoInstalacion = 6;
            public const long TipoMantenimiento = 7;
            public const long TipoProgramacion = 8;
            public const long TipoTabla = 10010;
        }
