...
{
    /// <summary>
    /// Controladora de Bandeja de Perspectivaes
    /// </summary>
    /// <remarks>
    ...
    public class BandejaPerspectivaController : BaseController
    {
        #region Propiedades
        /// <summary>
        ...
        /// <returns></returns>
        public ActionResult Index(BandejaPerspectivaRequest filtro)
        {
            ...
            //modelo.ListaObjetivoEstrategicoFonafe.AddRange(objetivoEstrategicoEmpresaService.BuscarObjetivoEstrategicoEmpresa(new BandejaObjetivoEstrategicoEmpresaRequest()
            //{
            //    CodigoIdioma = filtro.CodigoIdioma,                
