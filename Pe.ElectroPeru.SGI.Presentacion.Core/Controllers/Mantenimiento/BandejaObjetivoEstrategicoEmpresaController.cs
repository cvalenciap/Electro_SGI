...
{
    /// <summary>
    /// Controladora de Bandeja de ObjetivoEstrategicoEmpresaes
    /// </summary>
    /// <remarks>
    ...
    public class BandejaObjetivoEstrategicoEmpresaController : BaseController
    {
        #region Propiedades
        /// <summary>
        ...
        /// <returns></returns>
        public ActionResult Index(BandejaObjetivoEstrategicoEmpresaRequest filtro)
        {
