...
namespace Pe.ElectroPeru.SGI.Infraestructura.CommandModel.Mapping.Politicas
{
    /// <summary>
    ...
    public class ParametroValorMapping : BaseEntityMapping<ParametroValorEntity>
    {
        ...
        public ParametroValorMapping()
            : base()
        {
            HasKey(x => new{ x.CodigoParametro, x.CodigoSeccion, x.CodigoValor}).ToTable("PARAMETRO_VALOR", "POL");
